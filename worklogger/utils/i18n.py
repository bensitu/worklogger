...
- Supported UI languages include English, Japanese, Korean, Simplified Chinese, and Traditional Chinese.""",
    ...
    "local_model_select_hint": "Each user can select one active local model. Downloaded GGUF files are shared across users.",
    "local_model_switch_confirm": "Switch only the current user's active model. Shared model files are kept unless you delete them.",
